...
# version = 6.1
params_path = "./data_generator/results/"
...
os.makedirs(os.path.join(params_path, values_version_folder), exist_ok=True)
os.makedirs(os.path.join(params_path, "graphs/"), exist_ok=True)
